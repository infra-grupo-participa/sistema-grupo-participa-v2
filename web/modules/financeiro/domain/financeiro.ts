...
export const STATUS_ORDEM: StatusFinanceiro[] = [
  'vencido', 'sem_acordo', 'oferta_enviada', 'a_vencer', 'em_pagamento',
...
export function resumir(contas: ContaReceber[]): Resumo {
  ...
  return {
    ...
    semAcordo: vivos.filter((c) => c.status_financeiro === 'sem_acordo').length,
...
export interface Filtros {
  ...
  gaveta: 'todos' | 'vencido' | 'sem_acordo' | 'a_receber' | 'quitado';
}
